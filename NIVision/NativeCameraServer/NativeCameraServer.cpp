...
extern "C" {
void c_CameraServer_StartImageCaputre(const char* cameraName)
{
	CameraServer::GetInstance()->StartAutomaticCapture(cameraName);
}
bool c_CameraServer_IsAutoCaptureStarted()
{
	return CameraServer::GetInstance()->IsAutoCaptureStarted();
}
void c_CameraServer_SetQuality(unsigned int quality)
{
	CameraServer::GetInstance()->SetQuality(quality);
}
unsigned int c_CameraServer_GetQuality()
{
	return CameraServer::GetInstance()->GetQuality();
}
void c_CameraServer_SetSize(unsigned int size)
{
