...
namespace HAL.Base
{
    public partial class HALSerialPort
    {
        ...
        public static HAL_DisableSerialTerminationDelegate HAL_DisableSerialTermination;

        public delegate void HAL_SetSerialReadBufferSizeDelegate(int port, int size, ref int status);
        public static HAL_SetSerialReadBufferSizeDelegate HAL_SetSerialReadBufferSize;

        public delegate void HAL_SetSerialWriteBufferSizeDelegate(int port, int size, ref int status);
        public static HAL_SetSerialWriteBufferSizeDelegate HAL_SetSerialWriteBufferSize;
        ...
        public static HAL_FlushSerialDelegate HAL_FlushSerial;

        public delegate void HAL_ClearSerialDelegate(int port, ref int status);
        public static HAL_ClearSerialDelegate HAL_ClearSerial;

        public delegate void HAL_CloseSerialDelegate(int port, ref int status);
        public static HAL_CloseSerialDelegate HAL_CloseSerial;
    }
}
