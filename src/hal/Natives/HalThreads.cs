...
public static partial class HalThreads
{
    ...
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I4)]
    public static partial bool SetCurrentThreadPriority([MarshalAs(UnmanagedType.I4)] bool realTime, int priority, out HalStatus status);

    [AutomateStatusCheck(StatusCheckMethod = HalBase.StatusCheckCall)]
    [LibraryImport("wpiHal", EntryPoint = "HAL_SetThreadPriority")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I4)]
    internal static unsafe partial bool SetThreadPriority(void* handle, [MarshalAs(UnmanagedType.I4)] bool realTime, int priority, out HalStatus status);
