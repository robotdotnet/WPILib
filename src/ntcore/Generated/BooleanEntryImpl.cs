...
internal sealed class BooleanEntryImpl : EntryBase, BooleanEntry
{
     ...
     */
    internal BooleanEntryImpl(BooleanTopic topic, int handle, bool defaultValue) : base(handle)
    {
        Topic = topic;
    ...
    {
        NetworkTableValue ntValue = NetworkTableValue.MakeBoolean(value, time);
        NtCore.SetEntryValue(Handle, ntValue);
    }

    public void SetDefault(bool value)
    {
        NetworkTableValue ntValue = NetworkTableValue.MakeBoolean(value);
