...
public static unsafe partial class NtCore
{
    ...
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    internal static partial NtListener AddListener(NtListenerPoller poller, [MarshalUsing(typeof(NtStringMarshaller), ElementIndirectionDepth = 1)] ReadOnlySpan<string> prefixes, nuint prefixesLen, EventFlags flags);
