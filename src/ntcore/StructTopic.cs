...
public sealed class StructTopic<T> : Topic, IEquatable<StructTopic<T>?>, IEqualityOperators<StructTopic<T>?, StructTopic<T>?, bool> where T : IStructSerializable<T>
{
    ...
    public IStructSubscriber<T> Subscribe(T defaultValue, PubSubOptions options = default)
    {
    ...
    public IStructPublisher<T> Publish(PubSubOptions options = default)
    {
    ...
    public IStructPublisher<T> PublishEx(string properties, PubSubOptions options = default)
    {
    ...
    public IStructEntry<T> GetEntry(T defaultValue, PubSubOptions options = default)
    {
